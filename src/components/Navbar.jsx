    ...
    <div className="px-2 sm:px-4 py-6 dark:bg-[#162daa]">
      <div className="flex flex-wrap items-center justify-between mx-auto">
        ...
        <div className="flex md:order-2">
          <div
            type="button"
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr- md:mr-20 dark:bg-[#2e4450] dark:hover:bg-[#537b91] dark:focus:ring-blue-800"
          >
            Sign In
          </div>
          <button
